...
let winAudio = new Audio ('./sounds/ganar.wav');
let loseAudio = new Audio ('./sounds/perdiste.wav');
let clickAudio = new Audio ('./sounds/click.wav');
let rightAudio = new Audio ('./sounds/iguales.wav');
let wrongAudio = new Audio ('./sounds/diferentes.wav');

//Apuntando al documneto HTML
